...
test_path = "/create_images_ellipses/images_split_balanced/test/"
train_path = "/create_images_ellipses/images_split_balanced/train/"
val_path = "/create_images_ellipses/images_split_balanced/val/"
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        if val_acc < best_val_acc:
            ...
            tc.save({'model_state_dict': model.state_dict(),
                    ...
                    'saved_models/vgg19_64_300e_best.ckpt')
...
def plot_metrics(train_loss, train_acc, val_loss, val_acc, n_epochs):
    ...
    ax[1].legend()
    fig.tight_layout()
    fig.savefig("figures_cnn/metrics_vgg19_300.eps")
...
if __name__ == "__main__":
    ...
    tc.save({'model_state_dict': model.state_dict(),
             ...
             }, "saved_models/vgg19_64_300e.ckpt")
